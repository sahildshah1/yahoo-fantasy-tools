...
top_half_teams = {'380.l.765649.t.10',
                  '380.l.765649.t.5', 
                  '380.l.765649.t.6',
                  '380.l.765649.t.7'}


outcomes =  {'380.l.765649.t.10': {'wins': '10',
  'losses': '4',
  'ties': 0,
  'percentage': '.714'},
...
def test_get_alternative_standings():
  ...
  expected = pd.DataFrame({'team_key': ['380.l.765649.t.10',
  '380.l.765649.t.4',
  '380.l.765649.t.7',
  '380.l.765649.t.6',
  '380.l.765649.t.5',
 ...
 'percentage': [0.714, 0.5, 0.5, 0.857, 0.5, 0.429, 0.5, 0.429, 0.286, 0.286],
 'doubleheader_wins': [11, 7, 8, 13, 8, 6, 7, 6, 4, 4],
 'doubleheader_losses': [4, 8, 7, 2, 7, 9, 8, 9, 11, 11],
 'doubleheader_percentage': [0.7333333333333333,
  0.4666666666666667,
  0.5333333333333333,
  0.8666666666666667,
  0.5333333333333333,
